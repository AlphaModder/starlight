// This file copied from https://github.com/rust-lang-nursery/futures-rs/blob/0.2/futures-executor/src/unpark_mutex.rs
// If that file becomes public, or if this is merged into `futures`, then it will be unecessary. 
